...
**CS @ Cornell Tech '26 · Full-Stack Software Engineer**

I build scalable backend services, interactive frontends, and end-to-end systems — from REST APIs and CI/CD pipelines to AI-powered applications and blockchain protocols.
...
| Project | Description | Stack |
|---------|------------|-------|
| [**oracle-settler**](https://github.com/YuxiangJiangCT/oracle-settler) | Decentralized prediction market with dual-source verification and AI arbitration. 84 test cases. [Live →](https://oracle-settler.vercel.app) | Solidity · React · Chainlink |
| [**shadow-bet**](https://github.com/YuxiangJiangCT/shadow-bet) | Private prediction markets with ZK-proof identity concealment. [Live →](https://shadow-bet.vercel.app) | Solidity · React · ZK-Proofs |
| [**DarkRFQ**](https://github.com/YuxiangJiangCT/DarkRFQ) | RFQ execution with Fully Homomorphic Encryption. Bids stay encrypted on-chain. | Solidity · FHE · React |
...
<div align="center">
  <i>Open to full-stack, backend, and infrastructure engineering opportunities.</i>
</div>
